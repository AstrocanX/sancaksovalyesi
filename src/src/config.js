const config = {
    ...
    users: {
        ownerId: '594960088272470054', // The bot owner ID, which is you.
        developers: ['594960088272470054', '495994851066642432'] // The bot developers, remember to include your account ID with the other account IDs.
    },
